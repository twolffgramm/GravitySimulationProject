...
public class ButtonPanel extends JPanel
{
  ...
  JCheckBox repulsion;
  JComboBox<String> listePlaneten;
  ...
  public ButtonPanel(SimulationsModel simulationsModel)
  {
    ...
    repulsion.setActionCommand("repulsion");
    repulsion.setBackground(Color.decode("#1F1F1F"));
    repulsion.setForeground(Color.WHITE);
    
    listePlaneten = new JComboBox<String>();
    listePlaneten.setActionCommand("listePlaneten");
    updateListePlaneten();

    try
    {
      Image szenarienIcon = ImageIO.read(new File("/Users/timwolffgramm/Documents/GitHub/GravitySimulationProject/n-body-simulation/src/main/resources/BurgerMenu.png"));
      Image startIcon = ImageIO.read(new File("/Users/timwolffgramm/Documents/GitHub/GravitySimulationProject/n-body-simulation/src/main/resources/Play.png"));
      Image pauseIcon = ImageIO.read(new File("/Users/timwolffgramm/Documents/GitHub/GravitySimulationProject/n-body-simulation/src/main/resources/Pause.png"));
      Image zuruecksetzenIcon = ImageIO.read(new File("/Users/timwolffgramm/Documents/GitHub/GravitySimulationProject/n-body-simulation/src/main/resources/Reset.png"));
      Image editorIcon = ImageIO.read(new File("/Users/timwolffgramm/Documents/GitHub/GravitySimulationProject/n-body-simulation/src/main/resources/Edit.png"));
    ...
    this.platzhalterLinks.add(listePlaneten);
    this.platzhalterLinks.add(minimalerAbstandsSlider);
  }
  
  public void updateListePlaneten() 
  {
  	int ausgewaehlt = listePlaneten.getSelectedIndex();
  	listePlaneten.removeAllItems();
  	listePlaneten.addItem("");
  	for (int i = 0; i < simulationsModel.getPlaneten().size(); i++)
  	{
  		listePlaneten.addItem(String.valueOf(i));
  	}
  	
  	if (ausgewaehlt >= listePlaneten.getItemCount())
  	{
  		listePlaneten.setSelectedIndex(0);
  	}
  	else
  	{
    	listePlaneten.setSelectedIndex(ausgewaehlt);
  	}
  }
  ...
  public void registerListener(ButtonController buttonController)
  {
    ...
    listePlaneten.addActionListener(buttonController);
    repulsion.addActionListener(buttonController);
  }
